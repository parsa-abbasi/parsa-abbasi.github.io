...
$$ \phi_i = \frac{1}{|F|!} \sum_{S \subseteq F \setminus \{i\}} \binom{|S|}{|S|} \binom{|F|-|S|-1}{|F|-|S|-1} \left( v(S \cup \{i\}) - v(S) \right) $$
